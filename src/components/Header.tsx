...
import NavigationLinkss from '@/components/NavigationLinks';
 ...
 *
 * It contains a {@link NavigationLinks} component and a {@link ThemeSwitch} component.
 *
 * @returns The navigation bar component.
 */
/******  155ffdfd-2c1c-47d9-bae9-54c9909dfa34  *******/ const NavigationBar = () => {
    return (
